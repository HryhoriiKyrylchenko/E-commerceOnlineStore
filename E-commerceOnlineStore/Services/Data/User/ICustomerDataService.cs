...
namespace E_commerceOnlineStore.Services.Data.User
{
    ...
    public interface ICustomerDataService
    {
        ...
        Task<OperationResult<Customer>> AddCustomerAsync(CustomerRegistrationModel model);
        ...
        /// <returns>An <see cref="OperationResult{Customer}"/> object containing the result of the operation.</returns>
        Task<OperationResult<Customer>> DeleteCustomerAsync(string customerId);
        ...
        /// <returns>An <see cref="OperationResult{Customer}"/> object containing the result of the operation.</returns>
        Task<OperationResult<Customer>> GetCustomerByIdAsync(string customerId);
        ...
        /// <returns>An <see cref="OperationResult{Customer}"/> object containing the result of the operation.</returns>
        Task<OperationResult<Customer>> GetCustomerByEmailAsync(string email);

        /// <summary>
        /// Retrieves all customers asynchronously.
        /// </summary>
        /// <returns>A task that represents the asynchronous operation, containing a list of <see cref="Customer"/> objects.</returns>
        ...
        /// <returns>An <see cref="OperationResult{Customer}"/> object containing the result of the operation.</returns>
        Task<OperationResult<Customer>> UpdateProfileAsync(string userId, UpdateProfileModel model);
        ...
        /// <returns>An <see cref="OperationResult{Customer}"/> object containing the result of the operation.</returns>
        Task<OperationResult<Customer>> ChangePasswordAsync(string userId, ChangePasswordModel model);
        ...
        /// <returns>An <see cref="OperationResult{Customer}"/> object containing the result of the operation.</returns>
        Task<OperationResult<Customer>> ChangePhoneAsync(string userId, ChangePhoneModel model);
        ...
        /// <returns>An <see cref="OperationResult{Customer}"/> object containing the result of the operation.</returns>
        Task<OperationResult<Customer>> UpdateUserSettingsAsync(string userId, UpdateSettingsModel model);
        ...
        /// <returns>An <see cref="OperationResult{Customer}"/> object containing the result of the operation.</returns>
        Task<OperationResult<Customer>> ChangeEmailAsync(string userId, ChangeEmailModel model);
    }
}
